...
1. In 1-2 sentences, explain what React's `useRouteMatch` hook is used for.
   it overrides the default value. deafult id=1; and matches the id to movie /movie/1 /movie/2/
1. How would you explain form validation to someone who has never programmed before?
   it is code setsup to ensure that the data inputted is valid, otherwise the backend will be filled with nonsense data or return an error page.
1. In 1-2 sentences, define end to end testing.
   End-to-end testing tests funcitonality and performance of an application on UI side as well as server. it focuses on mimmicing user experience and interaction with clicks, form submits, etc through simulation.
